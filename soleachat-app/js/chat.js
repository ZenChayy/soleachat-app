class ChatManager {
    ...
    loadMessages() {
        ...
        // Si pas vérifié, afficher le message d'attente EN DESSOUS des messages
        if (!this.isVerified) {
            // Afficher d'abord les messages (dont celui de Clara)
            messages.forEach(msg => this.renderMessage(msg));
            
            // Puis le message d'attente
            ...
            // Si vérifié, afficher juste les messages
            messages.forEach(msg => this.renderMessage(msg));
        }
